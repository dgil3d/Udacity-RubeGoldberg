...
public int currentObject = 0;
	...
	public void MenuOn()
	{
		if(objectList[currentObject].activeInHierarchy == false)
		{
			objectList[currentObject].SetActive(true);
		}
		else if(objectList[currentObject].activeInHierarchy == true)
		{
	...
	{
		if(objectList[currentObject].activeInHierarchy == true)
		{
